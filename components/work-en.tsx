    ...
    <div className='my-4 md:my-6'>
      ...
      <div className='my-4 md:my-6'>
        ...
        <div className='my-4 prose prose-sm prose-neutral max-w-none md:prose-base'>
          <p>Responsible for the development of game growth platform, mainly participating in the infrastructure construction, performance optimization and feature development of the delivery and supplier platform.</p>
          <ul>
